...
export default function EvidencePanel({ edge, evidence, entities, onClose, onCollapse }: Props) {
  ...
  return (
    <div className="evidence-panel">
      ...
      {/* AI Rationale placeholder */}
      <div className="rationale-section">
        <button className="explain-btn" disabled>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M12 2a7 7 0 0 1 4.6 12.3c-.4.3-.6.8-.6 1.2V17H8v-1.5c0-.4-.2-.9-.6-1.2A7 7 0 0 1 12 2z" />
            <path d="M8 21h8M10 17v4M14 17v4" />
          </svg>
          Explain this connection
        </button>
        <p className="rationale-note">Gemini integration coming soon</p>
      </div>
    </div>
  );
}
