...
GEMINI_OVERVIEW_LOCATION="${GEMINI_OVERVIEW_LOCATION:-global}"
GEMINI_OVERVIEW_MODEL_FALLBACKS="${GEMINI_OVERVIEW_MODEL_FALLBACKS:-}"
...
deploy() {
  ...
  env_vars="^##^GCP_PROJECT_ID=${PROJECT_ID}##GCP_REGION=${REGION}##GEMINI_OVERVIEW_MODEL=${GEMINI_OVERVIEW_MODEL}##GEMINI_OVERVIEW_LOCATION=${GEMINI_OVERVIEW_LOCATION}##GEMINI_OVERVIEW_MODEL_FALLBACKS=${GEMINI_OVERVIEW_MODEL_FALLBACKS}"
